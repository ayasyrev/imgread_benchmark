...
def test_imagenette_urls():
    ...
    assert provider.get_url("full") == "https://s3.amazonaws.com/fast-ai-imageclas/imagenette2.tgz"
    assert provider.get_url("320") == "https://s3.amazonaws.com/fast-ai-imageclas/imagenette2-320.tgz"
    assert provider.get_url("160") == "https://s3.amazonaws.com/fast-ai-imageclas/imagenette2-160.tgz"
