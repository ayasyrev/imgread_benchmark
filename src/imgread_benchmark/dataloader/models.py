...
STORAGE_MODES = ("files", "memory")


def validate_storage(reader_id, storage):
    if storage not in STORAGE_MODES:
        raise ValueError(f"Unknown storage {storage!r}; choose {STORAGE_MODES}")
...
class DataLoaderConfig:
    ...
    def __post_init__(self):
        ...
        validate_storage(self.reader, self.storage)
